...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      'bg-muted/40 [&_tr]:border-b [&_th:first-child]:pl-4 [&_th:last-child]:pr-4',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn(
      '[&_tr:last-child]:border-0 [&_td:first-child]:pl-4 [&_td:last-child]:pr-4',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('py-3 px-2 align-middle text-sm text-foreground', className)}
    {...props}
  />
))
