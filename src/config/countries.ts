...
export const countries: readonly Country[] = [
  ...
  { id: 44, alpha2: 'BS', alpha3: 'BHS', name: 'Bahamas (the)' },
  ...
  { id: 86, alpha2: 'IO', alpha3: 'IOT', name: 'British Indian Ocean Territory (the)' },
  ...
  { id: 180, alpha2: 'CD', alpha3: 'COD', name: 'Congo (the Democratic Republic of the)' },
  ...
  { id: 408, alpha2: 'KP', alpha3: 'PRK', name: "Korea (the Democratic People's Republic of)" },
  { id: 410, alpha2: 'KR', alpha3: 'KOR', name: 'Korea (the Republic of)' },
  ...
  { id: 498, alpha2: 'MD', alpha3: 'MDA', name: 'Moldova (the Republic of)' },
