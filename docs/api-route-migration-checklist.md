...
- [ ] `GET` `/salePayments` — security: `serviceProviderOrClient` _(source: ../keepon-full/api-server/src/routes/sale-payments.get.ts)_
- [ ] `POST` `/salePayments` — security: `serviceProviderOrClient` _(source: ../keepon-full/api-server/src/routes/sale-payments.post.ts)_
- [ ] `DELETE` `/salePayments/:paymentId` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sale-payments.[paymentId].delete.ts)_
...
- [ ] `PATCH` `/salePayments/:paymentId` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sale-payments.[paymentId].patch.ts)_
...
- [ ] `POST` `/saleProducts` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sale-products.post.ts)_
- [ ] `DELETE` `/saleProducts/:saleProductId` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sale-products.[saleProductId].delete.ts)_
...
- [ ] `PATCH` `/saleProducts/:saleProductId` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sale-products.[saleProductId].patch.ts)_

## Sales (sales)

- [x] `GET` `/sales` — security: `serviceProviderOrClient` _(source: ../keepon-full/api-server/src/routes/sales.get.ts)_
- [ ] `POST` `/sales` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sales.post.ts)_
- [ ] `DELETE` `/sales/:saleId` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sales.[saleId].delete.ts)_
- [ ] `GET` `/sales/:saleId` — security: `serviceProviderOrClient` _(source: ../keepon-full/api-server/src/routes/sales.[saleId].get.ts)_
- [ ] `PATCH` `/sales/:saleId` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sales.[saleId].patch.ts)_
- [ ] `DELETE` `/sales/:saleId/paymentRequest` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sales.[saleId].payment-request.delete.ts)_
...
- [ ] `POST` `/sessionInvitations` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/session-invitations.post.ts)_
...
- [ ] `DELETE` `/sessions/:sessionId/clients/:clientId` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sessions.[sessionId].clients.[clientId].delete.ts)_
...
- [ ] `PUT` `/sessions/:sessionId/notes/:noteId` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/sessions.[sessionId].notes.[noteId].put.ts)_
...
- [ ] `POST` `/sessionSeries` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/session-series.post.ts)_
...
- [ ] `GET` `/stripe/account` — security: `serviceProviderOrClient` _(source: ../keepon-full/api-server/src/routes/stripe.account.get.ts)_
- [ ] `POST` `/stripe/account_links` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/stripe.account_links.post.ts)_
- [ ] `GET` `/stripe/external_accounts` — security: `serviceProvider` _(source: ../keepon-full/api-server/src/routes/stripe.external_accounts.get.ts)_
